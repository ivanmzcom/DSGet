...
private actor APIConfiguration {
    var baseURL: URL?
...
public final class SynologyAPIClient: Sendable {
    ...
    ///   - progress: Optional callback with (bytesReceived, totalBytes). totalBytes may be -1 if unknown.
    ...
    public func downloadRawDataWithProgress(
        ...
        // Synology returns JSON error responses even for download endpoints
